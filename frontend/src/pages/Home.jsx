...
import { FaCalendarAlt, FaUsers, FaMapMarkerAlt, FaSearch, FaClock, FaTicketAlt } from 'react-icons/fa';
...
const Home = () => {
  ...
  return (
    <div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-gray-300 mb-8">
                From electrifying concerts to inspiring talks, thrilling sports events to intimate gatherings. 
            ...
            {featuredEvent ? (
              <div className="relative">
                <div className="bg-white rounded-2xl overflow-hidden shadow-2xl cursor-pointer hover:scale-105 transition-transform duration-300">
                  <img
                    src={featuredEvent.image && featuredEvent.image !== 'default.jpg' 
                      ? featuredEvent.image 
                  ...
                  <div className="absolute top-6 right-6 bg-white px-4 py-2 rounded-lg shadow-lg">
                    <p className="text-green-600 font-semibold text-sm">Next Event</p>
                    <p className="text-black font-bold">{getTimeUntilEvent(featuredEvent.date)}</p>
                  </div>
                  
                  <div className="absolute top-6 left-6 bg-purple-600 text-white px-4 py-2 rounded-lg shadow-lg">
                    <p className="font-semibold text-sm">{featuredEvent.category}</p>
                  </div>
                  ...
                  <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/90 to-transparent p-6">
                    ...
                    <div className="flex items-center justify-between">
                      <span className="text-white text-2xl font-bold">{getPriceRange(featuredEvent)}</span>
                      <button 
                        onClick={() => navigate(`/events/${featuredEvent._id}`)}
                ...
                <div className="absolute -bottom-8 -left-8 bg-white rounded-xl p-4 shadow-xl">
                  <div className="flex items-center space-x-2">
                    ...
                    <div>
                      <p className="text-2xl font-bold text-black">{getAttendees(featuredEvent)} Going</p>
              ...
              <div className="relative">
                <div className="bg-gray-200 rounded-2xl overflow-hidden shadow-2xl h-96 flex items-center justify-center">
                  {loading ? (
                    ...
                    <div className="text-center p-8">
                      ...
                      <p className="text-gray-600 text-xl">No upcoming events yet</p>
                      <Link to="/events" className="text-purple-600 hover:text-purple-700 font-semibold mt-2 inline-block">
                        Browse all events →
                      </Link>
                    </div>
                  )}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-20">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                <p className="text-3xl font-bold">{events.reduce((sum, e) => sum + (e.totalTickets - e.remainingTickets), 0)}+</p>
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                <p className="text-3xl font-bold">{new Set(events.map(e => e.location)).size}+</p>
      ...
      {/* ✅ CONDITIONAL CTA - Only show if NOT Organizer or Admin */}
      {!isOrganizer && !isAdmin && (
       <section className="bg-black text-white py-20 mt-20">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <Link to="/register" className="bg-white text-black px-8 py-4 rounded-lg font-semibold text-lg hover:bg-gray-100 inline-block">
            Become an Organizer
          </Link>
